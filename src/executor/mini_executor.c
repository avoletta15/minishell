...
/*   Updated: 2024/02/21 17:54:06 by arabelo-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// @param args 
void	parent_excution(t_terminal *terminal, char **args)
{
...
{
	if (is_a_single_builtin(terminal->commands))
		parent_excution(terminal, terminal->commands->args);
}
